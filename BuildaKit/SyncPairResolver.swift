...
public class SyncPairResolver {
    ...
    public func resolveActionsForCommitAndIssueWithBotIntegrations(
        ...
        integrations: [Integration]) -> SyncPair.Actions {
            ...
            */
            ...
            if headCommitIntegrations.isEmpty {
            ...
            if !pending.isEmpty {
                ...
                var pendingSortedArray: [Integration] = Array(pending).sorted(by: { (integrationA, integrationB) -> Bool in
    ...
    func headCommitIntegrationsFromAllIntegrations(headCommit: String, allIntegrations: [Integration]) -> [Integration] {
        ...
        //1) for this SHA
        let headCommitIntegrations = uniqueIntegrations.filterSet { (integration: Integration) -> Bool in
        ...
        let sortedHeadCommitIntegrations = Array(headCommitIntegrations).sorted { (a: Integration, b: Integration) -> Bool in
